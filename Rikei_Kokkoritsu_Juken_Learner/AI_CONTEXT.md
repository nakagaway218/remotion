# AI Context: Rikei Kokkoritsu Juken Learner

## Purpose

This folder contains a local HTML helper for a high-school learning QA workflow aimed primarily at science-track students preparing for Japanese national/public university entrance exams.
...
- `SUBAGENT_PROMPT.md`: dedicated prompt for delegating Learner maintenance to a sub-agent.
